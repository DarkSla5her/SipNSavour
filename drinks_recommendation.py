...
st.title("Let's recommend you something to drink")


## nav = st.sidebar.radio("Navigation",["Home","IF Necessary 1","If Necessary 2"])

st.subheader("Do you want an alcoholic or non-alcoholic drink?")
vegn = st.radio("Select one",["Alcoholic","Non-alcoholic"],index = 1) 
